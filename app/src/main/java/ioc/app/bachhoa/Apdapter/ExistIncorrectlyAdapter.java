...
public class ExistIncorrectlyAdapter extends RecyclerView.Adapter<ExistIncorrectlyAdapter.ViewHoler> {
    private Context context;
    private List<ProductOnShelf> list;

    public ExistIncorrectlyAdapter(Context context) {
    ...
    public ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_table_exits_incorrectly, parent, false);
    ...
    public class ViewHoler extends RecyclerView.ViewHolder {
        ...
        public ViewHoler(@NonNull View itemView) {
            super(itemView);
            barcode = itemView.findViewById(R.id.item_ei_barcode);
            shelf = itemView.findViewById(R.id.item_ei_shelf);
            systemExist = itemView.findViewById(R.id.item_ei_system_exsits);
        }
    }
